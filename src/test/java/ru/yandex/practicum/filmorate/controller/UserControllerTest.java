...
//        assertEquals(inMemoryUserStorage.findUserById(1), user);
...
////        assertTrue(inMemoryUserStorage.findUserById(1L).getFriends().contains(2L));
////        assertTrue(inMemoryUserStorage.findUserById(2L).getFriends().contains(1L));
////    }
////
////    @Test
...
////
////        assertFalse(inMemoryUserStorage.findUserById(1L).getFriends().contains(1L));
////        assertFalse(inMemoryUserStorage.findUserById(2L).getFriends().contains(1L));
////    }
//}